# Doppler AspNet HypermediaApi Helpers
...
* `Response.StatusCode == 401 (Unauthorized)` and render an `Doppler.AspNetCore.HypermediaApi.Problems.UnauthorizedProblem`
* `Response.StatusCode == 403 (Forbidden)` and render a `Doppler.AspNetCore.HypermediaApi.Problems.ForbiddenProblem`
* `Response.StatusCode == 404 (Not Found)` and render a `Doppler.AspNetCore.HypermediaApi.Problems.RouteNotFoundProblem`
* Any `Doppler.AspNetCore.Authentication.Abstractions.AuthenticationException` and render them as `Doppler.AspNetCore.HypermediaApi.Problems.AuthenticationErrorProblem`
* Any `Doppler.AspNetCore.HypermediaApi.ExceptionHandling.ApiException` and render the inner problem (`Problem` property)
* Any _unhandled exception_ and render them as `Doppler.AspNetCore.HypermediaApi.Problems.UnexpectedProblem`
